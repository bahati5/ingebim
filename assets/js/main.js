!(function (e) {
  ...
  e("[data-sec-pos]").length &&
    ...
    e(".testi-slider-indicator").length &&
      e(".testi-slider-indicator").thTab({
        sliderTab: !0,
    ...
    (e.fn.shapeMockup = function () {
      e(this).each(function () {
        var t = e(this),
          ...
          n = t.data("bottom"),
          i = t.data("left");
        t.css({ top: s, right: a, bottom: n, left: i })
          .removeAttr("data-top")
  ...
  var g = {
    ...
    lines: function () {
      return this.each(function () {
        ...
        m(e(this).children("br").replaceWith(t).end(), t, "line", "");
      });
    },
  };
  (e.fn.lettering = function (t) {
    ...
    e(".hero-title-anime").lettering(),
    e(document).on("mouseover", ".project-card4", function () {
      e(this).addClass("project-card4-active"),
        e(".project-card4").removeClass("project-card4-active"),
        e(this).addClass("project-card4-active");
    }),
